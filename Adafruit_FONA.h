...
boolean Adafruit_FONA::postData(const char *deviceID, float number, float battLevel) {
...
/********************************* 3G HTTPS FUNCTION *********************************/
boolean Adafruit_FONA_3G::postData(const char *deviceID, float number, float battLevel) {
  // Need to open socket/enable GPRS before using this function
